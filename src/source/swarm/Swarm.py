...
from .shaders import ComputeCache, RenderCache, FadeCache
...
class Swarm:
    ...
    def set_size(self, size: int):
        ...
        ssbo = int(self.agents) # int cast failed in implementation !?
